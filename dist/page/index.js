...
Component({
    ...
    methods: {
        onClickFeedback(event) {
            ...
            const deviceInfo = wx.getDeviceInfo(), windowInfo = wx.getWindowInfo(), appBaseInfo = wx.getAppBaseInfo(), systemSetting = wx.getSystemSetting(), appAuthorizeSetting = wx.getAppAuthorizeSetting(), launchOptions = wx.getLaunchOptionsSync();
